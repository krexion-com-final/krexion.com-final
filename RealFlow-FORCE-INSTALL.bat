@echo off
REM ============================================================
REM  RealFlow FORCE INSTALL - Skip virtualization check
REM ============================================================
...
title RealFlow Force Installer (Skip Virt Check)
color 0E
...
powershell -ExecutionPolicy Bypass -NoProfile -File "%~dp0RealFlow-ULTIMATE-INSTALL.ps1" -SkipVirtCheck
