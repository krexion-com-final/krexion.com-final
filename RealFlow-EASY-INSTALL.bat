@echo off
REM +==================================================================+
REM |   RealFlow ONE-CLICK INSTALLER (Easy Edition)                     |
REM |                                                                    |
REM |   What this does:                                                  |
REM |   1. Auto-elevates to Administrator                                |
REM |   2. Checks/Installs Docker Desktop                                |
REM |   3. Downloads RealFlow code from GitHub (ZIP - no git needed)     |
...
set "TEMP_ZIP=%TEMP%\realflow-source.zip"
set "TEMP_EXTRACT=%TEMP%\realflow-extract"
set "LOG=%~dp0RealFlow-Install.log"

REM --- Clear old log ---
echo RealFlow Easy Install - %DATE% %TIME% > "%LOG%"

REM --- Run main PowerShell installer ---
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0RealFlow-EASY-INSTALL.ps1"
