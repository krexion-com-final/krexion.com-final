...
taskkill /FI "WINDOWTITLE eq RealFlow Backend*" /T /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq Administrator: RealFlow Backend*" /T /F >nul 2>&1

echo [STOP] Frontend window band kar raha hoon...
taskkill /FI "WINDOWTITLE eq RealFlow Frontend*" /T /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq Administrator: RealFlow Frontend*" /T /F >nul 2>&1
...
color 0A
echo.
echo [STOP] Done. RealFlow services band ho gayi hain.
