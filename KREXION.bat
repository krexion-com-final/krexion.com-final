...
REM ###################################################################
REM #                                                                 #
REM #              KREXION - THE ONE FILE INSTALLER                  #
REM #                                                                 #
...
REM #  - Installs/updates WSL2 + Docker + Krexion                    #
...
echo  ###################################################################
echo  #                                                                 #
echo  #         KREXION - ONE-CLICK BULLETPROOF INSTALLER              #
echo  #                                                                 #
...
echo     [4] Krexion download (latest from GitHub)
...
set "PS_FILE=%TEMP%\krexion-install-master.ps1"
...
REM ========== STEP 6: Cleanup ==========
if "%PS_FILE%"=="%TEMP%\krexion-install-master.ps1" del "%PS_FILE%" >nul 2>&1
...
echo  #     Desktop pe "Krexion-Credentials.txt" file mein hai         #
echo  #                                                                 #
echo  ###################################################################
echo.
pause
