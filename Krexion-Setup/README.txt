...
----------
  ...
  5.  Click "OPEN KREXION" when done.
...
----------------------------
  ...
  OK  Downloads the Krexion code from GitHub
  ...
  OK  Creates a "Krexion" shortcut on your Desktop
...
(Krexion-Setup\) to a USB stick. The "bundle\" subfolder will now
contain:
...
-------------
  ...
  Password:               (shown by the wizard + saved in
                           C:\krexion\.env  ?  ADMIN_PASSWORD)

  Desktop shortcut "Krexion" ? opens http://localhost:3000
...
---------
  ...
  * Double-click the "Krexion" desktop shortcut.
  * Done.

  To STOP:  open  C:\krexion\  and double-click  LOCAL-STOP.bat
  To LOGS:  double-click  KREXION-LOGS.bat
     ...
     for 1 second then closes -- nothing happens"
       ...
       ? Most common causes:
           ...
           4. You only extracted Install.bat -- not the whole folder.
              Re-extract the entire Krexion-Setup folder.
...
-------
  ...
  Detailed Urdu guide:    C:\krexion\DEPLOY-README-URDU.md
  8 GB tuning guide:      C:\krexion\DYNABOOK-8GB-GUIDE.md
