...
title RealFlow Installer DEBUG
color 0B

echo ==========================================
echo   RealFlow Installer - DEBUG MODE
echo ==========================================
echo.
...
curl.exe -s -o nul -w "HTTP %%{http_code}\n" -H "Authorization: Bearer !GH_PAT!" -H "User-Agent: RealFlow-Test" --max-time 30 "https://api.github.com/repos/ronaldsexedwards40-glitch/dynabook"
echo.
...
curl.exe -s -H "Authorization: Bearer !GH_PAT!" -H "Accept: application/vnd.github.v3.raw" -H "User-Agent: RealFlow-Test" --max-time 30 "https://api.github.com/repos/ronaldsexedwards40-glitch/dynabook/contents/.installer-status?ref=main"
echo.
