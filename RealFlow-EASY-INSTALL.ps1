# ============================================================
#  RealFlow EASY INSTALLER -- PowerShell Engine
# ============================================================
#  Called by RealFlow-EASY-INSTALL.bat after self-elevation.
...
# ============================================================
Clear-Host
Write-Banner "RealFlow ONE-CLICK INSTALLER"
Write-Host "  This will install RealFlow on your PC." -ForegroundColor White
...
Write-Host "    2. Download RealFlow code from GitHub" -ForegroundColor Gray
...
# ============================================================
Write-Banner "Step 5 / 7 :: Downloading RealFlow source code"
...
if (Test-Path $InstallDir) {
    ...
    if (Test-Path $InstallDir) {
        Show-Friendly-Error `
            ...
            "FIX:`n  1. Close all programs (VS Code, file explorer windows open on C:\realflow)`n  2. Open Task Manager -> end any 'docker' processes`n  3. Restart your PC`n  4. Run this installer again"
    }
}
...
try {
    ...
    Show-Friendly-Error `
        "Could not download RealFlow source from GitHub." `
        "Possible fixes:`n  - Check internet connection`n  - Manually download: $ZipUrl`n  - Extract to C:\realflow`n  - Re-run this installer"
}
...
# Move from temp\realflow-extract\dynabook-main\* to C:\realflow\*
...
@"
# Auto-generated by RealFlow-EASY-INSTALL on $((Get-Date).ToString('yyyy-MM-dd HH:mm'))
DB_NAME=realflow
...
# ============================================================
Write-Banner "Step 7 / 7 :: Building and starting RealFlow"
...
if ($LASTEXITCODE -ne 0) {
    ...
    Show-Friendly-Error `
        ...
        "Common fixes:`n  - Make sure Docker Desktop is running (whale icon in tray)`n  - Make sure you have at least 5 GB free disk space`n  - Try running: cd C:\realflow && docker compose build`n  - Check $LogFile for the exact error"
}
...
if ($LASTEXITCODE -ne 0) {
    ...
    Show-Friendly-Error `
        ...
        "Try:`n  - Wait 30 seconds, then: cd C:\realflow && docker compose up -d`n  - Check Docker Desktop -> Containers tab for error details"
}
...
if ($backendOk) {
    ...
    Write-Log "Backend timeout -- check 'docker compose logs backend' in C:\realflow" "WARN"
}
...
Write-Log "Created Desktop shortcut: RealFlow.url" "OK"
...
Write-Host "                                                            " -ForegroundColor Green
Write-Host "         REALFLOW IS NOW RUNNING!                           " -ForegroundColor Green
Write-Host "                                                            " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
Write-Host ""
...
Write-Host "    Email    : admin@realflow.local" -ForegroundColor Yellow
Write-Host "    Password : $adminPass" -ForegroundColor Yellow
Write-Host ""
Write-Host "    (Save this password! It's also in C:\realflow\.env)" -ForegroundColor Gray
Write-Host ""
...
Write-Host "    cd C:\realflow" -ForegroundColor Gray
...
Write-Host ""
Write-Host "  Desktop shortcut: RealFlow.url" -ForegroundColor Gray
Write-Host ""
Write-Host "============================================================" -ForegroundColor Green
Write-Host ""
