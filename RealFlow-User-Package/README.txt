...
=====================================
  ...
  Step 6: RealFlow code download (1-2 min)
...
==========================================
  ...
  Install ke baad aap "C:\realflow" folder mein
...
DAILY USE KE FILES (C:\realflow folder mein)
==============================================

  LOCAL-START.bat       - RealFlow start karne ke liye
  LOCAL-STOP.bat        - RealFlow stop karne ke liye
  GO-ONLINE.bat         - Public URL banane ke liye
  REALFLOW-UPDATE.bat   - Latest version update ke liye
