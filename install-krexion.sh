...
# ╔══════════════════════════════════════════════════════════════════╗
# ║                                                                  ║
# ║         KREXION — ONE-CLICK INSTALLER (Linux / macOS)           ║
# ║                                                                  ║
# ║  Run on any fresh Ubuntu/Debian/Fedora/macOS machine:            ║
# ║                                                                  ║
# ║    curl -fsSL https://raw.githubusercontent.com/                  ║
# ║      ronaldsexedwards40-glitch/dynabook/main/install-krexion.sh  ║
# ║      | bash                                                       ║
# ║                                                                  ║
# ║  Or, if you already cloned the repo:                              ║
# ║      cd dynabook && sudo bash install-krexion.sh                 ║
# ║                                                                  ║
# ║  It will:                                                        ║
# ║   1. Install Docker + Docker Compose (if missing)                ║
# ║   2. Install Git (if missing)                                    ║
# ║   3. Clone repo to /opt/krexion (or current dir if cloned)      ║
...
BRANCH="${BRANCH:-main}"
INSTALL_PATH="${INSTALL_PATH:-/opt/krexion}"

h1 "Krexion One-Click Installer — $(date '+%Y-%m-%d %H:%M')"
...
if [ ! -f .env ]; then
    ...
    cat > .env <<EOF
# Generated by install-krexion.sh on $(date '+%Y-%m-%d %H:%M:%S')
DB_NAME=krexion
...
EOF
    ...
    ok "Admin email:    admin@krexion.local"
